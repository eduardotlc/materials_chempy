#!/usr/bin/env python3
"""
Created on 2026-06-28 12:29:26.

@author: eduardotc
@contributors: lu4vic
@email: eduardotcampos@hotmail.com

Client module commands and flags handling, running and integration.
"""
...
app = typer.Typer(
    ...
    help="Python client tools utils on inorganic chemistry & materials science data handling.",
    no_args_is_help=True,
)

chromatography_app = typer.Typer(help="Chromatograpgy (GC/LC) data treatment and plotting.")
app.add_typer(chromatography_app, name="chromatograpgy")

console = Console()

@app.command()
def test():
    Console.print("AAAAAAAAAAAA")
